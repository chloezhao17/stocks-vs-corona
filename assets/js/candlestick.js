...
function drawGraph(data) {
    ...
    // shouldn't need following 3 lines
  ...
  function buildGraph2() {
    ...
    fetch("https://pomber.github.io/covid19/timeseries.json")
      ...
      .then((data) => {
        console.log(data["US"]);
        var chart2 = am4core.create("bar", am4charts.XYChart);
        ...
        var cSeries = chart2.series.push(new am4charts.LineSeries());
        cSeries.dateFormatter.inputDateFormat = "yyyy-M-d";
        cSeries.dataFields.valueY = "confirmed";
        cSeries.dataFields.dateX = "date";
        cSeries.tooltipText = "{valueY.value} Confirmed Cases";
        chart2.series.push(cSeries);
        chart2.cursor = new am4charts.XYCursor();
  
        var dSeries = chart2.series.push(new am4charts.LineSeries());
        dSeries.dataFields.valueY = "deaths";
        dSeries.dataFields.dateX = "date";
        chart2.series.push(dSeries);
        chart2.cursor = new am4charts.XYCursor();
        dSeries.tooltipText = "{valueY.value} Confirmed Cases";
      });
    ...
    //       ) *
    //         0.5;
    //     document.getElementById("fromfield").value = chart2.dateFormatter.format(
    //       minZoomed,
    //       inputFieldFormat
    //     );
    //     document.getElementById("tofield").value = chart2.dateFormatter.format(
    //       new Date(dateAxis.maxZoomed),
    //       inputFieldFormat
    //     );
    //   }
    ...
    //         return;
    //       }
    //       var startDate = chart2.dateFormatter.parse(start, inputFieldFormat);
    //       var endDate = chart2.dateFormatter.parse(end, inputFieldFormat);
